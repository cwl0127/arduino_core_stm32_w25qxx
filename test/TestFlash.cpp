...
#define SPI3_CS_PIN PC13

SPIClass spi3(PB5, PB4, PB3);
SPISettings spiSetting(SPI_SPEED_CLOCK_DIV2_MHZ, MSBFIRST, SPI_MODE3);

//SPIFlash flash;                   
SPIFlash flash(SPI3_CS_PIN, &spi3);       //Use this constructor if using an SPI bus other than the default SPI. Only works with chips with more than one hardware SPI bus
